...
if $DO_BACKEND; then
  ...
  REQUIRED_MODULES="
    ...
    app.engine.brk.brk_runtime
    app.engine.brk.brk_manager
    app.engine.brk.brk_engine
    app.engine.brk.brk_live_core
    app.api.brk_v1_state_routes
    app.jobs.brk_live_eod
