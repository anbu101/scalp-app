...
export default function Backtest() {
  ...
  const [strategyId, setStrategyId] = useState(
     ...
     ["SCALP_V1", "SCALP_V3", "SCALP_V5", "HA_V1", "HA_SELL", "IC_V1", "IC_V2", "TSG_V1", "GC_V1", "PST_SELL", "PST_HEDGE", "TMA_V1", "TMA_V2", "VET_V1", "CBO_V1", "BRK_V1"].includes(saved.strategyId) /* ── VAP_BT_UI_HIDE_20260827 ── VAP_V1 removed: stale saved selection falls back to SCALP_V1 */ ? saved.strategyId : "SCALP_V1"
  );
    ...
    <div style={{
      ...
      <Card elevated style={{ padding: spacing.lg, marginBottom: spacing.xl }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: spacing.md }}>
          ...
          {!isIC && !isTSG && !isPST && !isTMA && !isTMA2 && !isGC && !isVET && !isCBO && !isBRK && (
            <>
          ...
          {!isV5 && !isHA && !isIC && !isTSG && !isPST && !isTMA && !isTMA2 && !isGC && !isVET && !isCBO && !isBRK && (
            <>
