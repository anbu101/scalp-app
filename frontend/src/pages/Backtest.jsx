...
export default function Backtest() {
  ...
  const buildConfig = useCallback((sid) => {
    ...
    brkSelTime, brkSelBelow, brkSelMin, brkBreak, brkSustain, brkFirst, brkLast, brkBoth, brkSl, brkTp, brkFb, brkFbMin, brkS2, brkS2Sel, brkS2First, brkS2Last, brkS2Flat, brkS2Loss, brkEod, brkLots, brkLotSize, brkSkipExpiry,
    orbOrbMin, orbTrigger, orbPremMax, orbPremMin, orbTargetMode, orbTargetVal, orbSlMode, orbSlPts, orbSlFill, orbSlTrig, orbSlDistMode, orbPremSlMode, orbPremSlVal, orbBlockTime, orbMaxDay, orbMaxSide, orbEod, orbLots, orbLotSize, orbSkipExpiry,   // ── ORB_V1_UI_20260903 ── STALE-CLOSURE RULE: buildConfig reads every one of these.
      v1BoEnabled, v1BoStart, v1BoEnd, v1MaxTradesDay,   // ── SCALP_V1_BT_FILTERS_UI_20260823 ──
      v1Workers,   // ── SCALP_V1_PARALLEL_20260823 ──
      v1RiskSizing, v1RupeeRisk, v1MaxSpread,   // ── SCALP_V1_ENTRY_SIZING_20260823 ──
      v1EmaGate, v1EmaPeriod, v1EmaLookback, v1EmaMinSlope, v1TpMult,   // ── SCALP_V1_EMA_GATE_20260824 ──
  ...
  const downloadCsv = useCallback(async () => {
    ...
    try {
      const csv = buildCsv(trades, summary, metrics, resultStrategy, resultConfig, summary?.diag_cbo || summary?.diag_brk);   // ── CBO_PARAMS_EXPORT_20260830 ── ── BRK_V1_UI_20260830 ──
