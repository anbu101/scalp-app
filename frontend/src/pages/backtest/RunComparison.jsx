...
import { fmtIcSl, cboParamSummary, brkParamSummary } from "./paramFormat";   // ── IC_IV_SL ── ── CBO_PARAMS_EXPORT_20260830 ──
...
const STRAT_LABEL = { SCALP_V1: "V1", SCALP_V3: "V3", SCALP_V5: "V5", HA_V1: "HA", HA_SELL: "HAS", WICK_V1: "WICK", IC_V1: "IC", IC_V2: "IC2", PST_V1: "PST", PST_SELL: "PSTS", PST_HEDGE: "PSTH", TMA_V1: "TMA", TMA_V2: "TMA2", TSG_V1: "TSG", GC_V1: "GC", VAP_V1: "VAP", VET_V1: "VET", CBO_V1: "CBO", BRK_V1: "BRK" };   // ── BRK_V1_UI_20260830 ──
    ...
    <Card elevated style={{ padding: spacing.lg, marginBottom: spacing.lg }}>
      <div style={{ display: "flex", gap: spacing.md, alignItems: "center", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
          ...
          {["ALL", "SCALP_V1", "SCALP_V3", "SCALP_V5", "HA_V1", "HA_SELL", "IC_V1", "IC_V2", "PST_SELL", "PST_HEDGE", "TMA_V1", "TMA_V2", "TSG_V1", "GC_V1", "VET_V1", "CBO_V1", "BRK_V1" ].map((sId) => ( /* ── RUN_FAVOURITES_20260830 ── CBO/BRK chips */ /* ── VAP_BT_UI_HIDE_20260827 ── VAP_V1 filter chip removed; historical VAP runs still list under ALL */
            <button key={sId}
