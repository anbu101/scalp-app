...
import { fmtIcSl, cboParamSummary, brkParamSummary, orvParamSummary, orbParamSummary } from "./paramFormat";   // ── IC_IV_SL ── ── CBO_PARAMS_EXPORT_20260830 ──
