...
const C = {
  bg:        T.bg.primary,
  page:      T.bg.page,     // ── THEME_KOLAM_P2_20260906 ── root canvas only; bg keeps row striping
...
export default function Analytics() {
  ...
  return (
    <div style={{ padding: 24, background: C.page, color: C.text, minHeight: "100vh", fontFamily: FONT }}>   {/* ── THEME_KOLAM_P2_20260906 ── */}
