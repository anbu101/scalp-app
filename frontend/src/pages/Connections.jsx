...
export default function Connections() {
  ...
  if (loading) {
    return (
      <div style={{ padding: spacing.xxl, background: colors.bg.page, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", color: colors.text.primary }}>   {/* ── THEME_KOLAM_P2_20260906 ── */}
        Loading...
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: isMobile ? spacing.md : spacing.xxl, background: colors.bg.page, color: colors.text.primary, minHeight: "100vh" }}>   {/* ── THEME_KOLAM_P2_20260906 ── */}
