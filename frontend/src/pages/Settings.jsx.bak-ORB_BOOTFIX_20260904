...
function AdminSettings() {
  ...
  if (!scalpConfig || !bbConfig || !bbV2Config || !haConfig || !scalpV3Config || !scalpV5Config || !icConfigs.IC_V1 || !icConfigs.IC_V2 || !pstSellConfig || !pstHedgeConfig || !tmaConfig || !tma2Config || !tsgConfig || !vetConfig || !brkConfig) {   // ← TSG_V1, TMA_V2, BRK_V1 added
    return (
