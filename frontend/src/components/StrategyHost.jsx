...
// ── HOST_PANEL_FIT_20260921 BEGIN ── desktop focus column sizing.
...
export default function StrategyHost({ ltpMap }) {
  ...
  return (
    <div style={{ display: "flex", gap: spacing.md, alignItems: "stretch", width: "100%" }}>
      ...
      <div
        key={effectiveFocus}
        style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", animation: "hostFocusIn 0.32s cubic-bezier(0.22,1,0.36,1)" }}   /* ── HOST_PANEL_FIT_20260921 ── flex column */
      >
        <KillSwitch strategyId={effectiveFocus} />
