...
import GCV1Panel    from "../strategies/gc_v1/GCV1Panel.jsx";     // ── GC_V1 ──
...
const ACTIVE_STRATEGY_IDS = ["SCALP_V1", "SCALP_V3", "SCALP_V5", "IC_V1", "IC_V2", "TSG_V1", "GC_V1", "BB_V1", "BB_V2", "HA_V1", "PST_SELL", "PST_HEDGE", "TMA_V1"];
...
const META = {
  ...
  GC_V1:    { name: "Glacier", accent: "#38bdf8" },          // ── GC_V1 ──
...
function renderPanel(strategyId, ltpMap) {
  ...
  switch (strategyId) {
    ...
    case "GC_V1":    return <GCV1Panel    {...common} />;    // ── GC_V1 ──
