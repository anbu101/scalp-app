...
export const STRATEGY_REGISTRY = [
  ...
  // ── PST_REMOVAL_20260909 ── PST_SELL / PST_HEDGE retired.
  {
    id: "SCALP_V3",
    label: "Scalp V3",
    broker: "ZERODHA",
  ...
  // ── TMA_V2 BEGIN ──
  {
    ...
    capabilities: {
      hasSelection: true,   // premium≤cap scan at ts-60 (SELL + hedge ladder)
      hasSlots:     false,  // TMA2TradeManager owns all state (tma2_trades)
      hasCEPE:      false,  // fixed template: SELL opposite the trend + hedge
    },
  },
  // ── TMA_V2 END ──
  ...
  // ── BRK_V1 BEGIN ──
  {
    ...
    label: "BRK V1",
    broker: "ZERODHA",
    timeframe: "1m",                    // decisions ONLY at 1m closes
    modeSupported: ["PAPER", "LIVE"],
    capabilities: {
      hasSelection: true,   // 09:25 nearest-below ₹180, both sides watched
      hasSlots:     false,  // BrkManager owns all state (paper_trades)
      hasCEPE:      true,   // the bought side is CE or PE by the break
    },
  },
  // ── BRK_V1 END ──
  // ── TSG_V1 BEGIN ──
