# backend/app/engine/tma/tma_live_core.py
#
# ── TMA_V1 LIVE CORE ── PURE (no app imports on the hot path, unit-tested)
# ============================================================================
...
# proven by test_tma_live_core.py, which runs BOTH over randomized days and
