# backend/app/engine/tma2/test_tma2_live_core.py
#
# ── TMA_V2 LIVE CORE PARITY PROOF ──
...
# and hard-close days. Run:  python3 -m pytest test_tma2_live_core.py -q
# (also runnable standalone: python3 test_tma2_live_core.py)
...
# V2 reuses the V1 monitor by import (single source of truth for the
# per-candle fill conventions) — tma_v2_engine re-exports it, so this
# proves the LIVE monitor against the exact function the V2 RUNNER uses.
from tma_v2_engine import monitor_position_day          # noqa: E402
from tma2_live_core import (new_position, step_candle,   # noqa: E402
...
if __name__ == "__main__":
    ...
    print("OK — tma2_live_core parity proven (400 randomized trials)")