...
_EXPECTED_COLUMNS = {
    ...
    "backtest_runs": {
        ...
        # ── RUN_FAVOURITES_20260830 ── user annotations; additive, self-healed on old DBs
    ...
    with _connect() as c:
        rows = c.execute(
            ...
            SELECT run_id, strategy_id, underlying, date_from, date_to,
                   ...
                   favourite, note   -- ── RUN_FAVOURITES_20260830 ──
            FROM backtest_runs
