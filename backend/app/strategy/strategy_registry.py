STRATEGIES = {
    ...
    # ── PST_REMOVAL_20260909 ── PST_SELL / PST_HEDGE retired: registry entries, launch
    # loop, managers and runners removed. Tables pst_sell_trades /
    # pst_hedge_trades are left in place (history is never dropped).
    "HA_V1": {
        "enabled": True,
        "broker": "ZERODHA",
        "timeframe": "1m",
